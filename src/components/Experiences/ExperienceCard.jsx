...
const ExperienceCard = ({
  ...
  return (
    <div
      className="experience cursor-pointer relative w-[43.277vw] p-2 lg:p-4 lg:w-full h-[210px] lg:h-[52.263vh] flex flex-col justify-end items-end text-white overflow-hidden"
